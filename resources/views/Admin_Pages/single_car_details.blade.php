...
<div class="container">
    <div class="row">
        <div class="col-md-4 mb-6" style = "position:relative; left:-40px;">
            <div class="project-info-box mt-0" >
                <h5>Car Details</h5>
                <p class="mb-0">{{$Clist->car_details}}</p>
            </div><!-- / project-info-box -->

            <div class="project-info-box">
                <p><b>Dealer: <a href="{{ route('admin single user details',['id'=>encrypt($Clist->owner_id)]) }}"></b>{{$Clist->car_owner_name}}</a></p>
                <p><b>Type: </b>{{$Clist->car_type}}</p>
                <p><b>Date of Buying: </b>{{$Clist->car_buy_date}}</p>
                <p><b>Color: </b> {{$Clist->car_color}}</p>
                <p class="mb-0"><b>Sit Number: </b>{{$Clist->sit_number}}</p>
            </div><!-- / project-info-box -->

            <div class="project-info-box mt-0 mb-0">
                <p class="mb-0">
                    <span class="fw-bold mr-10 va-middle hide-mobile">Share:</span>&nbsp;
                    <a href="#x" class="feather feather-facebook me-2 icon-inline text-primary"><i class="fab fa-facebook-f"></i></a>&nbsp;&nbsp;
                    <a href="#x" class="feather feather-twitter me-2 icon-inline text-info"><i class="fab fa-twitter"></i></a>&nbsp;
                    <a href="#x" class="feather feather-pinterest me-2 icon-inline text-primary"><i class="fab fa-pinterest"></i></a>
                </p>
            </div><!-- / project-info-box -->
        </div><!-- / column -->

        <div class="col-md-8 mb-7"style = "position:relative; left:100px;">
            <img src="{{asset('car_pic/'.$Clist->car_pic)}}" alt="project-image" class="rounded">
            <div class="project-info-box">
                <p><b>Car Name: </b>{{$Clist->car_name}}</p>
                <p><b>Car Model: </b>{{$Clist->car_model}}</p>
                <p><b>Rent Price: </b><b>{{$Clist->rent_price}}</b><small> per day</small> </p>
