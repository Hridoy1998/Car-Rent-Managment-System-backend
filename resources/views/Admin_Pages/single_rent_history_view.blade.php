                        ...
                        <div class="payment-details">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <a href="{{ route('admin single user details',['id'=>encrypt($myinfo->id)]) }}">{{$myinfo->username }} </a><br>
                                    {{$myinfo->address }} <br>
                                    </p>
                                </div>
                                <div class="col-sm-6 text-right">
                                    ...
                                    <a href="{{ route('admin single user details',['id'=>encrypt($client_info->id)]) }}">{{$client_info->username }} </a><br>
                        ...
                        <div class="line-items">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('single_car_details_view',['id'=>encrypt($Clist->id)]) }}">{{$Clist->id}}</a>
                                    </td>
                                    <td>
                                        {{$Clist->rent_price}}
                                    </td>
